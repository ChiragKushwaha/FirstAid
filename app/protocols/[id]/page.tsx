...
export default function ProtocolDetailPage() {
  ...
  if (!protocol) {
    return (
      <div className="min-h-screen bg-canvas text-main flex flex-col items-center justify-center px-6">
        <p className="text-2xl font-bold mb-4">Protocol Not Found</p>
        <button
          onClick={() => router.back()}
          className="px-6 py-3 rounded-full bg-black text-white dark:bg-white dark:text-black font-bold"
        >
          Go Back
        </button>
      </div>
